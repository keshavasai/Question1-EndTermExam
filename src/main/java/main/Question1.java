...
public class Question1 {
	public static void main(String[] args){
		...
		case 2:
		{
		Mechanical a = new Mechanical();
			//this case is or Mechanical
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			System.out.println(a.displayCourseDetails("Mechanical"));//call the function of the class that you initialized
			break;
		}
		case 3:
		{
